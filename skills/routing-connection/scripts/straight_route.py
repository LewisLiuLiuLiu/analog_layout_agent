...
用法:
    python straight_route.py --source M1.drain_N --target M2.drain_S
"""
...
def main():
    parser = argparse.ArgumentParser(description='直连布线')
    ...
    try:
        ...
        result = server.call_tool("straight_route", params)
