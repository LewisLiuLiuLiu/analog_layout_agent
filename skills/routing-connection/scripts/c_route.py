...
用法:
    python c_route.py --source M1.source_S --target M3.source_S --extension 5.0
"""
...
def main():
    parser = argparse.ArgumentParser(description='C形布线')
    ...
    parser.add_argument('--extension', type=float, default=None, help='延伸距离(μm)')
    ...
    try:
        ...
        result = server.call_tool("c_route", params)
