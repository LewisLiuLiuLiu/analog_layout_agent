...
用法:
    python create_pmos.py --width 3.0 --fingers 4 --with-dummy
"""
...
def main():
    parser = argparse.ArgumentParser(description='创建 PMOS 晶体管')
    ...
    parser.add_argument('--fingers', type=int, default=1, help='指数')
    ...
    parser.add_argument('--with-tie', action='store_true', default=True, help='添加N阱连接')
    ...
    try:
        ...
        result = server.call_tool("create_pmos", params)
